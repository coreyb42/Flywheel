...
public final class HitboxComponent implements EntityComponent {
	...
	public void beginFrame(DynamicVisual.Context context) {
		...
		var shouldRenderHitBoxes = Minecraft.getInstance().debugEntries
				.isCurrentlyEnabled(net.minecraft.client.gui.components.debug.DebugScreenEntries.ENTITY_HITBOXES);
